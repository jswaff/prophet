...
TEST(pos_test, apply_move_sequence1)
{
    ...
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnb1kbnr/pp1ppppp/8/q1p5/4P3/5N2/PPPPBPPP/RNBQK2R b KQkq - 3 3");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));

    mv = to_capture(QUEEN, A5, D2, PAWN);
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnb1kbnr/pp1ppppp/8/2p5/4P3/5N2/PPPqBPPP/RNBQK2R w KQkq - 0 4");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));

    mv = to_capture(KNIGHT, B1, D2, QUEEN);
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnb1kbnr/pp1ppppp/8/2p5/4P3/5N2/PPPNBPPP/R1BQK2R b KQkq - 0 4");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));

    mv = to_move(PAWN, C5, C4);
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnb1kbnr/pp1ppppp/8/8/2p1P3/5N2/PPPNBPPP/R1BQK2R w KQkq - 0 5");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));
    ...
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnb1kbnr/pp1ppppp/8/8/2p1P3/5N2/PPPNBPPP/R1BQ1RK1 b kq - 0 5");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));

    mv = to_move(KING, E8, D8);
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnbk1bnr/pp1ppppp/8/8/2p1P3/5N2/PPPNBPPP/R1BQ1RK1 w - - 1 6");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));

    mv = to_move(PAWN, B2, B4);
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnbk1bnr/pp1ppppp/8/8/1Pp1P3/5N2/P1PNBPPP/R1BQ1RK1 b - b3 0 6");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));
    ...
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnbk1bnr/pp1ppppp/8/8/4P3/1p3N2/P1PNBPPP/R1BQ1RK1 w - - 0 7");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));

    mv = to_move(ROOK, F1, E1);
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnbk1bnr/pp1ppppp/8/8/4P3/1p3N2/P1PNBPPP/R1BQR1K1 b - - 1 7");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));

    mv = to_move(PAWN, B3, B2);
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnbk1bnr/pp1ppppp/8/8/4P3/5N2/PpPNBPPP/R1BQR1K1 w - - 0 8");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));

    mv = to_move(KING, G1, H1);
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnbk1bnr/pp1ppppp/8/8/4P3/5N2/PpPNBPPP/R1BQR2K b - - 1 8");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));
    ...
    apply_move(&pos1, mv, &u);
    set_pos(&pos2, 
        "rnbk1bnr/pp1ppppp/8/8/4P3/5N2/P1PNBPPP/n1BQR2K w - - 0 9");
    EXPECT_TRUE(pos_equals(&pos1, &pos2, true));
}
