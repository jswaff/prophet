...
TEST(eval_test, outpost)
{
    ...
    ASSERT_TRUE(set_pos(&pos,"1r3rk1/3q1ppp/3p4/p1pNpP2/PpP1P1P1/1P3Q2/6KP/5R2 w - - 0 1"));
...
TEST(eval_test, outpost2)
{
    ...
    ASSERT_TRUE(set_pos(&pos,"r1br1k2/pp3pp1/1b4np/4P3/2pNN3/2P3B1/PP1R1PPP/3R2K1 w - - 0 1"));
