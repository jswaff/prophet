...
/**
 * @brief Is a move a capturing move?
 *
 * @param mv            the move
 *
...
/**
 * @brief Is a move an en-passant move?
 *
 * @param mv            the move
 *
...
/**
 * @brief Is a move a castling move?
 *
 * @param mv            the move
 *
...
/**
 * @brief Given a move, create an equivalent move without a score.
 *
 * @param mv            the move
 *
