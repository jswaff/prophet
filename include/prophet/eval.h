...
static const int32_t knight_val = 384;
static const int32_t bishop_val = 326;
static const int32_t bishop_pair = 31;
static const int32_t rook_val = 510;
static const int32_t queen_val = 974;
