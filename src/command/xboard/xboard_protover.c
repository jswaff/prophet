...
int xboard_protover(const char *input)
{
    ...
    /* this program supports protocol version 2 and higher */
    /*if (n < 2)
    {
    ...
    plog(
        "feature analyze=0 colors=0 draw=0 debug=1 memory=1 myname=\"Prophet\" name=0 nps=0 "
        "ping=1 setboard=1 sigint=0 sigterm=0 usermove=1 variants=\"normal\" done=1\n");
