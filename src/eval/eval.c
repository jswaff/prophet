...
/* pawn terms */
int32_t passed_pawn_mg                  =   31;
int32_t passed_pawn_eg                  =   32;
...
int32_t knight_tropism_eg               =   -8;

/* bishop terms */
int32_t bishop_mobility_mg              =    3;
int32_t bishop_mobility_eg              =    1;

/* rook terms */
int32_t rook_open_file_mg               =   33;
int32_t rook_open_file_eg               =   34;
int32_t rook_half_open_file_mg          =   20;
int32_t rook_half_open_file_eg          =   21;

/* queen terms */
int32_t queen_mobility_mg               =    1;
int32_t queen_mobility_eg               =    2;

int32_t major_on_7th_mg                 =   17;
int32_t major_on_7th_eg                 =   18;
int32_t connected_majors_on_7th_mg      =   64;
int32_t connected_majors_on_7th_eg      =   65;
