 ...
 *
 * The index is 0 based, with the LSB having an index of 0 and the MSB an index of 63.
 *
 ...
 *
 * The index is zero based, and works from the least significant bit to the most.  For example, given a bitmap with 
 * bit pattern 11010:
 *
 ...
 *
 * Passing an index greater than or equal to the number of bits set will yield a return value of 0.
 *
 ...
 *
 * Constructs a bitmap representing the sequence of squares starting from sq, in the direction of dir, to the edge of 
 * the board.
 *
 ...
 *
 * The returned bitmap can be used as a mask for isolating squares on the file of the given square.
 *
 * @param sq            a square
 *
 * @return a bitmap
 ...
 *
 * The returned bitmap can be used as a mask for isolating squares on the rank of the given square.
 *
 * @param sq            a square
 *
 * @return a bitmap
