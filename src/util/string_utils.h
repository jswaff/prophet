 ...
 *
 * The string should have length four, except for castling moves, which should have a length of five.  SAN notation is 
 * not supported.  Proper formatting is two characters for the source square, followed by two characters for the
 * destination square, followed by an optional promotion piece. Examples: e2e4, e7e8q, e1g1
 *
 ...
 *
 * The string should have a length of two.  The first character should be a letter A-H (lower or upper),and the second 
 * a number 1-8.  E.g. A1, b2, e3 are all valid.
 *
 ...
 *
 * Returns a pointer to a null-terminated string.  The returned pointer must be passed to free to avoid a memory leak.
 *
